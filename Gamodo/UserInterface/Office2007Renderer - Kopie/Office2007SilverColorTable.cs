...
namespace Gamodo.UserInterface.Office2007Renderer
{
    ...
    public class Office2007SilverColorTable : ProfessionalColorTable
    {
        ...
        */
        private static Color _overflowBegin = Color.FromArgb(124, 124, 148);
        private static Color _overflowEnd = Color.FromArgb(124, 124, 148);
        private static Color _overflowMiddle = Color.FromArgb(0, 0, 0);

        private static Color _separatorDark = Color.FromArgb(124, 124, 148);
        private static Color _separatorLight = Color.FromArgb(255, 255, 255);

        private static Color _gripDark = Color.FromArgb(124, 124, 148);
        private static Color _gripLight = Color.FromArgb(255, 255, 255);

        private static Color _menuToolBack = Color.FromArgb(228, 228, 238);

        private static Color _toolStripBorder = Color.FromArgb(124, 124, 148);
        private static Color _toolStripContentEnd = Color.FromArgb(124, 124, 148);
        private static Color _toolStripBegin = Color.FromArgb(243, 244, 250);
        private static Color _toolStripEnd = Color.FromArgb(164, 163, 190);
        private static Color _toolStripMiddle = Color.FromArgb(227, 228, 227);
        ...
        /// </summary>
        public Office2007SilverColorTable()
        {
        }
        #endregion
