...
namespace Gamodo.UserInterface.Office2007Renderer
{
    ...
    public class Office2007Renderer : ToolStripProfessionalRenderer
    {
        ...
        */
        ...
        //Button Border
        private static Color _r9 = Color.FromArgb(242,205, 84);
        private static Color _rA = Color.FromArgb(242, 205, 84);
        ...
        /// </summary>
        public Office2007Renderer(ProfessionalColorTable color)
            : base(color)
        {
        }
        #endregion
