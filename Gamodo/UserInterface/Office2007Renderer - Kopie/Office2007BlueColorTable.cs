...
namespace Gamodo.UserInterface.Office2007Renderer
{
    /// <summary>
    ...
    public class Office2007BlueColorTable : ProfessionalColorTable
    {
        ...
        private static Color _buttonBorder = Color.FromArgb(242, 205, 84);

        private static Color _imageMargin = Color.FromArgb(233, 238, 238);
        private static Color _menuBorder = Color.FromArgb(134, 134, 134);

        private static Color _menuToolBack = Color.FromArgb(196, 215, 255);
        ...
        private static Color _overflowBegin = Color.FromArgb(216, 228, 242);
        private static Color _overflowEnd = Color.FromArgb(216, 228, 242);
        private static Color _overflowMiddle = Color.FromArgb(216, 228, 242);

        private static Color _separatorDark = Color.FromArgb(157, 177, 204);
        private static Color _separatorLight = Color.FromArgb(196, 215, 255);

        private static Color _gripDark = Color.FromArgb(157, 177, 204);
        private static Color _gripLight = Color.FromArgb(196, 215, 255);

        private static Color _toolStripBorder = Color.FromArgb(216, 228, 242);
        private static Color _toolStripContentEnd = Color.FromArgb(164, 195, 235);
        private static Color _toolStripBegin = Color.FromArgb(216, 228, 242);
        private static Color _toolStripEnd = Color.FromArgb(216, 228, 242);
        private static Color _toolStripMiddle = Color.FromArgb(216, 228, 242);
        #endregion
